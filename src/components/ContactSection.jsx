        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6 md:space-y-8 stagger-item">
            ...
            <div className="p-5 md:p-6 rounded-2xl bg-gradient-to-r from-[#d40e7b]/10 to-[#9621ff]/5 border border-[#d40e7b]/20 stagger-item">
              ...
              <div className="flex gap-4">
                <a href={socialLinks.instagram} target="_blank" className="p-3 rounded-xl bg-white/5 hover:scale-110 transition-all">
                  <Instagram className="w-5 h-5 text-gray-400 hover:text-[#d40e7b]" />
                </a>
                <a href={socialLinks.tiktok} target="_blank" className="p-3 rounded-xl bg-white/5 hover:scale-110 transition-all">
          ...
          <div className="relative stagger-item">
            <div className="p-6 md:p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-sm">
              {isSubmitted ? (
                <div className="flex flex-col items-center py-12 stagger-item">
                  <CheckCircle className="w-10 h-10 text-green-500 mb-4" />
                  <h3 className="text-2xl font-bold text-white">Nachricht gesendet!</h3>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <Input className="stagger-item" placeholder="Name" />
                  <Input className="stagger-item" placeholder="E-Mail" />
                  <Input className="stagger-item" placeholder="Betreff" />
                  <Textarea className="stagger-item" placeholder="Nachricht" rows={5} />
                  <Button className="w-full malle-btn stagger-item">
