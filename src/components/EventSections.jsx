...
import { eventData, artists } from '@/data/mock';
import {
  Carousel,
  CarouselContent,
  CarouselItem,
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6">
          ...
          <div className="hidden md:flex items-center text-4xl text-[#d40e7b] font-bold animate-pulse">
            :
          </div>
          <TimeBlock value={timeLeft.hours} label="Stunden" />
          <div className="hidden md:flex items-center text-4xl text-[#9621ff] font-bold animate-pulse">
            :
          </div>
